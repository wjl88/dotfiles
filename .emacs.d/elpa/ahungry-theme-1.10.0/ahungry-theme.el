...
(let ((mainbg (when (display-graphic-p) "#101010")));; "default")))
  (custom-theme-set-faces
   ...
   '(font-lock-comment-face ((t (:foreground "#ff0000" :bold nil :italic t))))
   ...
   '(font-lock-string-face ((t (:foreground "#76ee00" :italic nil :bold nil))))
   ...
   '(org-level-1 ((t (:bold t :foreground "#5588ff" :height 1.4))))
